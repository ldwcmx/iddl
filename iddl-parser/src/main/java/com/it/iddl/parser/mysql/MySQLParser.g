...
//	|{input.LT(1).getText().toUpperCase().equals("DAY")}?  ID ->^(CONSIST ID)
	|{functionRegister.containsKey(input.LT(1).getText().toUpperCase())}? ID (LPAREN values_func? RPAREN )->^(ID values_func?)
	|{consistStringRegister.containsKey(input.LT(1).getText().toUpperCase())}? ID ->^(CONSIST ID)
//	|time_fuc
        |value
	|boolean_literal
	|'NULL'
...
//fuc_name
	//:{functionRegister.containsKey(input.LT(1).getText().toUpperCase())}? ID ->^(TIME_FUC_NAME ID)
...
unit
   ...
   //|{input.LT(1).getText().toUpperCase().equals("MONTH")}? ID->^(UNIT ID)
     :{consistStringRegister.containsKey(input.LT(1).getText().toUpperCase())}? ID->^(UNIT ID)
     ;
...
displayed_column
	:{functionRegister.containsKey(input.LT(1).getText().toUpperCase())}? ID (LPAREN values_func? RPAREN) alias?->^(ID values_func? alias?)
	|{consistStringRegister.containsKey(input.LT(1).getText().toUpperCase())}? ID alias? ->^(CONSIST ID alias?)
	|{functionRegister.containsKey(input.LT(1).getText().toUpperCase())}? ID LPAREN distinct_col RPAREN alias?->^(ID distinct_col alias?)
