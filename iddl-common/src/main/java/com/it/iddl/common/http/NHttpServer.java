package com.it.iddl.common.http;
...
public class NHttpServer  {
	...
	private String templateEncode = "utf-8";					// 模板编码
	private ConcurrentHashMap<String, Template> templateCache;	// 模板缓存
	 ...
	 * @param port
	 */
	public NHttpServer(String docRoot, int port) {
	...
	public void init() {
		...
		try {
			...
			Velocity.setProperty(Velocity.FILE_RESOURCE_LOADER_PATH, docRoot);
        ...
        reqistry.register("*", new HttpFileHandler(new File(docRoot)));
