...
public class LogicTableMatrix {
	...
	private TableRule globalTableRule = null;
	...
	public TableRule getGlobalTableRule() {
		return globalTableRule;
	}

	public void setGlobalTableRule(TableRule globalTableRule) {
