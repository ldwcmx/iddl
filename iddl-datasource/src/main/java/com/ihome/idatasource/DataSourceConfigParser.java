...
public class DataSourceConfigParser {
    ...
    public static Collection<LocalTxDataSourceConfig> parse(File file) throws DocumentException {
        ...
        Collection<LocalTxDataSourceConfig> result = new ArrayList<LocalTxDataSourceConfig>(localTxDatasources.size());
        for (Element localTxDatasource : localTxDatasources) {
            LocalTxDataSourceConfig ds = createLocalTxDataSourceConfig(localTxDatasource);
            result.add(ds);
        }
    ...
    private static LocalTxDataSourceConfig createLocalTxDataSourceConfig(Element localTxDatasource) {
