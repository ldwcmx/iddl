...
public class LocalTxDataSourceConfig  implements Cloneable{
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        LocalTxDataSourceConfig other = (LocalTxDataSourceConfig) obj;
	...
	public LocalTxDataSourceConfig clone() {
		LocalTxDataSourceConfig config = null;
		try {
			config = (LocalTxDataSourceConfig) super.clone();
