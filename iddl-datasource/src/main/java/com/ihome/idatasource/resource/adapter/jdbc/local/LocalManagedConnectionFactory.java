 ...
 */
package com.ihome.idatasource.resource.adapter.jdbc.local;
...
import com.ihome.idatasource.resource.JBossResourceException;
import com.ihome.idatasource.resource.adapter.jdbc.BaseWrapperManagedConnectionFactory;
...
public class LocalManagedConnectionFactory extends BaseWrapperManagedConnectionFactory {
	...
	public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo cri) throws javax.resource.ResourceException {
   ...
   public ManagedConnection matchManagedConnections(final Set mcs, final Subject subject, final ConnectionRequestInfo cri) throws ResourceException {
