...
public class AtomDatabaseMetaDataWrapper implements DatabaseMetaData {
	
	private final DatabaseMetaData targetMetaData;
	private final Connection targetConnection;

	public AtomDatabaseMetaDataWrapper(DatabaseMetaData targetMetaData, Connection targetConnection)
	{
		super();
			...
			throws SQLException
	{
		...
		return new AtomResultSetWrapper(null, this.targetMetaData.getAttributes(
	...
	{
		return new AtomResultSetWrapper(null, targetMetaData.getCatalogs());
	}

	public ResultSet getColumnPrivileges(String catalog, String schema,
			String table, String columnNamePattern) throws SQLException
	{
		return new AtomResultSetWrapper(null, targetMetaData.getColumnPrivileges(
	...
	public ResultSet getColumns(String catalog, String schemaPattern,
			...
			throws SQLException
	{
		return new AtomResultSetWrapper(null, targetMetaData.getColumns(catalog,
	...
	{
		return new AtomResultSetWrapper(null, targetMetaData.getCrossReference(
	...
	public ResultSet getExportedKeys(String catalog, String schema, String table)
			throws SQLException
	{
		return new AtomResultSetWrapper(null, targetMetaData.getExportedKeys(
	...
	public ResultSet getImportedKeys(String catalog, String schema, String table)
			throws SQLException
	{
		return new AtomResultSetWrapper(null, targetMetaData.getImportedKeys(
				catalog, schema, table));
	}
	...
	{
		return new AtomResultSetWrapper(null, targetMetaData.getIndexInfo(catalog,
	...
	public ResultSet getPrimaryKeys(String catalog, String schema, String table)
			throws SQLException
	{
		return new AtomResultSetWrapper(null, targetMetaData.getPrimaryKeys(
				catalog, schema, table));
	}
	...
	public ResultSet getProcedureColumns(String catalog, String schemaPattern,
			...
			throws SQLException
	{
		return new AtomResultSetWrapper(null,
	...
	{
		return new AtomResultSetWrapper(null, targetMetaData.getProcedures(
	...
	{
		return new AtomResultSetWrapper(null, targetMetaData.getSchemas());
	}
	...
	{
		return new AtomResultSetWrapper(null, targetMetaData.getSuperTables(
	...
	{
		return new AtomResultSetWrapper(null, targetMetaData.getSuperTypes(
	...
	public ResultSet getTablePrivileges(String catalog, String schemaPattern,
			String tableNamePattern) throws SQLException
	{
		return new AtomResultSetWrapper(null, targetMetaData.getTablePrivileges(
				catalog, schemaPattern, tableNamePattern));
	}

	public ResultSet getTableTypes() throws SQLException
	{
		return new AtomResultSetWrapper(null, targetMetaData.getTableTypes());
	}

	public ResultSet getTables(String catalog, String schemaPattern,
			String tableNamePattern, String[] types) throws SQLException
	{
		return new AtomResultSetWrapper(null, targetMetaData.getTables(catalog,
	...
	{
		return new AtomResultSetWrapper(null, targetMetaData.getTypeInfo());
	}

	public ResultSet getUDTs(String catalog, String schemaPattern,
			String typeNamePattern, int[] types) throws SQLException
	{
		return new AtomResultSetWrapper(null, targetMetaData.getUDTs(catalog,
	...
	{
		return new AtomResultSetWrapper(null, targetMetaData.getVersionColumns(
				catalog, schema, table));
	}
