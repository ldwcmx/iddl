 ...
 *
 */
public class AtomPreparedStatementWrapper extends AtomStatementWrapper implements java.sql.PreparedStatement {
	
	protected final String sql;

	public AtomPreparedStatementWrapper(Statement targetStatement, AtomConnectionWrapper connectionWrapper,
	...
	public ResultSet executeQuery() throws SQLException {
		...
		try {
			currentResultSet = new AtomResultSetWrapper(this, ((PreparedStatement) targetStatement).executeQuery());
